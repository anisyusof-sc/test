...
public class Validator {
	...
	private static Task parseAddCommand(String remainingCommand) {
	...
	private static NormalTask createNormalTask(String taskDesc, String remainingDate) {
	...
	private static DeadlineTask createDeadlineTask(String taskDesc, String remainingDate) {
	...
	private static RecurrenceTask createRecurrenceTask(String taskDesc, String remainingDate) {
	...
	private static FloatingTask createFloatingTask(String taskDesc, String remainingPriority) {
